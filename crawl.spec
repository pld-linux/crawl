...
%description -l pl
Crawl jest duø± i bardzo losow± gr± podziemnej eksploracji w
fantastycznym ∂wiecie magii i czÍstej przemocy. Twoim zadaniem jest
podrÛø w g≥±b Lochu (ktÛry w kaødej grze jest inny) i odzyskanie Kuli
Zota.

Crawl jest gr± RPG typu 'rogue-like', jednym z potomkÛw Rogue. Grafika
jest prosta, ale wysoce informatywna, zaprojektowana by byÊ zrozumia≥±
od pierwszego spojrzenia. Sterowanie odbywa siÍ g≥Ûwnie jedno
